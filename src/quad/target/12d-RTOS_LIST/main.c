...
void task1_task(void *pvParameters)
{
    ...
    while (1) {
        task1_counter++;
        LedToggle(LED4_NUM);
//        printf("Task1 is executed %d times.\r\n", task1_counter);
        vTaskDelay(1000);
    }
}
...
void list_task(void *pvParameters)
{
    /* Step 1: Initialise List and ListItems */
...
//    while (button.dev.btnPressed != true) {
//        button.dev.btnPressed = false;
//        delay(10);
//    }
    
    /* Step 2: Print the addresses of List and ListItems */
//    printf("+---- The address of List and ListItems ----+\r\n");
    printf("Contents                        Address     \r\n\r\n");
    printf("TestList                        0x%x\r\n", (int)&TestList);
    printf("TestList->pxIndex               0x%x\r\n", (int)TestList.pxIndex);
    printf("TestList->xListEnd              0x%x\r\n", (int)(&TestList.xListEnd));
    printf("ListItem1                       0x%x\r\n", (int)&ListItem1);
    printf("ListItem2                       0x%x\r\n", (int)&ListItem2);
    printf("ListItem3                       0x%x\r\n", (int)&ListItem3);
//    printf("+------------------- End -------------------+\r\n");
    ...
    /* Step 3: Add ListItem1 to TestList, and print out all the pxNext and pxPrevious members of the ListItems */
    vListInsert(&TestList, &ListItem1);

//    printf("+------------ Adding ListItem1 -------------+\r\n");
    printf("Contents                        Address     \r\n\r\n");
    printf("TestList->xListEnd              0x%x         \r\n", (int)(&TestList.xListEnd));
    printf("TestList->xListEnd->pxNext      0x%x         \r\n", (int)(TestList.xListEnd.pxNext));
    printf("ListItem1->pxNext               0x%x         \r\n", (int)ListItem1.pxNext);
    printf("TestList->xListEnd->pxPrevious  0x%x         \r\n", (int)(TestList.xListEnd.pxPrevious));
    printf("ListItem1->pxPrevious           0x%x         \r\n", (int)ListItem1.pxPrevious);
//    printf("+------------------- End -------------------+\r\n");
    ...
    /* Step 4: Add ListItem2 to TestList, and print out all the pxNext and pxPrevious members of the ListItems */
    vListInsert(&TestList, &ListItem2);

//    printf("+------------ Adding ListItem2 -------------+\r\n");
    printf("Contents                        Address     \r\n\r\n");
    printf("TestList->xListEnd->pxNext      0x%x         \r\n", (int)(TestList.xListEnd.pxNext));
    printf("ListItem1->pxNext               0x%x         \r\n", (int)ListItem1.pxNext);
    printf("ListItem2->pxNext               0x%x         \r\n", (int)ListItem2.pxNext);
    printf("TestList->xListEnd->pxPrevious  0x%x         \r\n", (int)(TestList.xListEnd.pxPrevious));
    printf("ListItem1->pxPrevious           0x%x         \r\n", (int)ListItem1.pxPrevious);
    printf("ListItem2->pxPrevious           0x%x         \r\n", (int)ListItem2.pxPrevious);
//    printf("+------------------- End -------------------+\r\n");
    ...
    /* Step 5: Add ListItem3 to TestList, and print out all the pxNext and pxPrevious members of the ListItems */
    vListInsert(&TestList, &ListItem3);

//    printf("+-------------------- Adding ListItem3 -----------------------+\r\n");
    printf("Contents                        Address     \r\n\r\n");
    printf("TestList->xListEnd->pxNext      0x%x         \r\n", (int)(TestList.xListEnd.pxNext));
    printf("ListItem1->pxNext               0x%x         \r\n", (int)ListItem1.pxNext);
    printf("ListItem2->pxNext               0x%x         \r\n", (int)ListItem2.pxNext);
    printf("ListItem3->pxNext               0x%x         \r\n", (int)ListItem3.pxNext);
    printf("TestList->xListEnd->pxPrevious  0x%x         \r\n", (int)(TestList.xListEnd.pxPrevious));
    printf("ListItem1->pxPrevious           0x%x         \r\n", (int)ListItem1.pxPrevious);
    printf("ListItem2->pxPrevious           0x%x         \r\n", (int)ListItem2.pxPrevious);
    printf("ListItem3->pxPrevious           0x%x         \r\n", (int)ListItem3.pxPrevious);
//    printf("+-------------------------- End ------------------------------+\r\n");    
...
//    printf("+-------------------------- End ------------------------------+\r\n");
    ...
    /* Step 7: Add ListItem2 to the end of the List */
